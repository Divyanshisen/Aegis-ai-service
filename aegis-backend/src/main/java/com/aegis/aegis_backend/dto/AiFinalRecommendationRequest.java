...
public class AiFinalRecommendationRequest {
    private Long missionId;
    private String emergencyType;
    private String request;
    private List<IntelligenceSnapshot> intelligence;

    public AiFinalRecommendationRequest() {}

    public AiFinalRecommendationRequest(Long missionId, String emergencyType, String request, List<IntelligenceSnapshot> intelligence) {
